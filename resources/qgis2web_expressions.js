...
function exp_EKHOTO_Path_19rule0_eval_expression(context) {
    // id = 5

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('id')  == 5);
    } else {
        return (feature.get('id')  == 5);
    }
}
...
function exp_EKHOTO_Forecast_24Jul_21rule0_eval_expression(context) {
    // order_id = 2

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('order_id')  == 2);
    } else {
        return (feature.get('order_id')  == 2);
    }
}
...
function exp_EKHOTO_Forecast_24Jul_21rule1_eval_expression(context) {
    // order_id = 3

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('order_id')  == 3);
    } else {
        return (feature.get('order_id')  == 3);
    }
}
...
function exp_EKHOTO_Forecast_24Jul_21rule2_eval_expression(context) {
    // order_id = 4

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('order_id')  == 4);
    } else {
        return (feature.get('order_id')  == 4);
    }
}
...
function exp_EKHOTO_Forecast_24Jul_21rule3_eval_expression(context) {
    // order_id = 5

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('order_id')  == 5);
    } else {
        return (feature.get('order_id')  == 5);
    }
}
...
function exp_EKHOTO_Forecast_24Jul_21rule4_eval_expression(context) {
    // order_id = 6

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('order_id')  == 6);
    } else {
        return (feature.get('order_id')  == 6);
    }
}
...
function exp_EKHOTO_Forecast_24Jul_21rule5_eval_expression(context) {
    // order_id = 1

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('order_id')  == 1);
    } else {
        return (feature.get('order_id')  == 1);
    }
}